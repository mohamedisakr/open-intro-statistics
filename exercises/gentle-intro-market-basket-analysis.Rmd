...
```{r}
retail_transaction <- read.transactions(here::here("data", "market-basket.csv"), format = 'basket', sep = ',')
...
rules <- apriori(retail_transaction, parameter = list(supp = 0.001, conf = 0.8))
